module Coupler::API
  class Builder
    ...
    def bootstrap
      ...
      injector.register_service('CsvImports::Download', CsvImports::Download)
      injector.register_service('CsvImportParams::Download', CsvImportParams::Download)
      injector.register_service('CsvImportValidators::Download', CsvImportValidators::Download)
      ...
      injector.register_service('LinkageResultExportRunner', LinkageResultExportRunner)
      injector.register_service('DatasetExportRunner', DatasetExportRunner)
